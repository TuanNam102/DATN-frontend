  ...
  return (
    <main className="bg-white min-h-screen pt-[120px] pb-24 font-body">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        >
          <h1 className="font-headline text-5xl md:text-7xl italic text-primary-deep mb-4">Journal</h1>
          ...
          {blogPosts.map((post, idx) => (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <h2 className="font-headline text-3xl md:text-4xl italic text-primary-deep group-hover:text-primary transition-colors leading-tight">
