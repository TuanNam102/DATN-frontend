    ...
    <main className="bg-white min-h-screen pt-[120px] pb-24 font-body">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <nav className="flex items-center justify-center gap-2 text-[10px] uppercase tracking-[0.2em] text-primary-deep/40 mb-12">
          ...
          <span className="text-primary-deep">Create Account</span>
        </nav>
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            <h1 className="font-headline text-5xl md:text-6xl italic text-primary-deep mb-4">Register</h1>
            <p className="text-primary-deep/60 text-sm">Please fill in the information below:</p>
          </motion.div>
          ...
          <form className="space-y-6">
            ...
            <div className="text-center pt-6 border-t border-gray-100">
              <p className="text-primary-deep/60 text-sm mb-4">Already have an account?</p>
              <Link
                to="/login"
