  ...
  return (
    <main className="bg-white min-h-screen pt-[120px] pb-24 font-body">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        >
          <h1 className="font-heading font-medium text-5xl md:text-6xl  text-primary-deep mb-4">Danh sách yêu thích</h1>
        ...
        {items.length > 0 ? (
                  ...
                  >
                    <td className="py-8">
                      <div className="flex items-center gap-6">
                        <Link to={`/product/${item._id}`} className="w-20 h-24 shrink-0 rounded-lg overflow-hidden bg-[#F9F9F9]">
                          <img src={item.image} alt={item.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        </Link>
                        <div>
                          <Link to={`/product/${item._id}`} className="font-heading font-medium text-xl  text-primary-deep hover:text-primary transition-colors block mb-1">
                            {item.name}
                          </Link>
          ...
          <div className="text-center py-24">
            ...
            <h3 className="text-2xl font-heading font-medium  text-primary-deep mb-4">Danh sách yêu thích đang trống</h3>
