    ...
    <main className="bg-white min-h-screen pt-[120px] pb-24 font-body">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <nav className="flex items-center justify-center gap-2 text-[10px] uppercase tracking-[0.2em] text-primary-deep/40 mb-12">
          ...
          <span className="text-primary-deep">About Us</span>
        </nav>
      </div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 mb-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h1 className="font-headline text-5xl md:text-7xl italic text-primary-deep mb-8 leading-tight">
              Crafting Essence, <br /> Defining Luxury.
            </h1>
            <p className="text-primary-deep/60 text-lg leading-relaxed mb-8 max-w-xl">
              Since 2010, Borcen has been dedicated to the art of fine perfumery. 
              Our journey began with a simple mission: to create scents that tell 
              a story, evoke a memory, and define an identity.
            </p>
            <div className="flex gap-12">
              <div>
                <h4 className="font-headline text-4xl italic text-primary-deep mb-1">15+</h4>
                <p className="text-[10px] uppercase tracking-widest text-primary-deep/40 font-bold">Years of Excellence</p>
              </div>
              <div>
                <h4 className="font-headline text-4xl italic text-primary-deep mb-1">50k+</h4>
      ...
      <section className="bg-[#F9F9F9] py-24">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 text-center mb-16">
          <h2 className="font-headline text-4xl md:text-5xl italic text-primary-deep mb-4">Our Core Values</h2>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-12">
          {[
            ...
            >
              ...
              <h3 className="font-headline text-2xl italic text-primary-deep mb-4">{value.title}</h3>
      ...
      <section className="py-24 max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h2 className="font-headline text-4xl md:text-5xl italic text-primary-deep">Our Meticulous Process</h2>
      ...
      <section className="py-24 bg-primary-deep text-white text-center rounded-[40px] mx-6 md:mx-12 overflow-hidden relative">
        ...
        <div className="relative z-10 px-6">
          <h2 className="font-headline text-4xl md:text-6xl italic mb-8">Join the World of Borcen</h2>
          <p className="text-white/60 text-lg mb-12 max-w-2xl mx-auto leading-relaxed">
            Stay updated with our latest releases, exclusive events, and the art of luxury scent.
          </p>
          <Link 
            to="/register"
