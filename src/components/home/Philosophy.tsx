  ...
  return (
    ...
    >
      <div className="space-y-12">
        ...
        <h3 className="font-headline text-5xl md:text-7xl text-white leading-tight">
        ...
        <div className="grid grid-cols-2 gap-8 pt-8">
          <div className="p-6 glass-luxury rounded-xl">
            <h5 className="font-headline text-xl text-white mb-2 italic">Bền vững</h5>
            <p className="text-sm text-white/70">Thực vật có nguồn gốc đạo đức từ các khu vườn tư nhân của chúng tôi.</p>
          </div>
          <div className="p-6 glass-luxury rounded-xl">
            <h5 className="font-headline text-xl text-white mb-2 italic">Nghệ thuật thủ công</h5>
