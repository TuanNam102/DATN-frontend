...
const ProductsManagement = () => {
  ...
  const handleOpenModal = (product: any, mode: 'view' | 'edit') => {
          ...
          <GlassCard className="w-full max-w-lg p-6 overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="flex justify-center mb-6">
                <div className="h-32 w-32 rounded-2xl bg-slate-100 overflow-hidden border border-white/60">
                  <img 
              ...
              <div className="space-y-1">
                ...
                {modalMode === 'view' ? (
                  <div className="flex">
                    <Badge tone={editingProduct.status === 'Còn hàng' ? 'green' : 'amber'}>
                  ...
                  >
                    ...
                    <option value="Tồn kho thấp">Tồn kho thấp</option>
...
const StatisticsManagement = () => {
  ...
  const categoryData = useMemo(() => [
    { name: 'Eau de Parfum', value: 55, amount: '₫2.75M', color: '#D56844' },
    { name: 'Eau de Toilette', value: 30, amount: '₫1.5M', color: '#4F8EF7' },
    { name: 'Bộ Quà Tặng', value: 15, amount: '₫750K', color: '#A0A0A0' },
  ], []);
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                  ...
                  <GlassCard className="p-5">
                    ...
                    <div className="mt-5 grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6 items-center">
                      <div className="h-[240px] relative">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              data={[
                                { name: 'Eau de Parfum', value: 50, color: '#D56844' },
                                { name: 'Eau de Toilette', value: 35, color: '#4F8EF7' },
                                { name: 'Bộ Quà Tặng', value: 15, color: '#A0A0A0' },
                              ]}
                              dataKey="value"
                              nameKey="name"
                              innerRadius={70}
                      ...
                      <div className="space-y-3">
                        {[
                          { name: 'Eau de Parfum', amount: '$1,081', value: 50, color: '#D56844' },
                          { name: 'Eau de Toilette', amount: '$323', value: 35, color: '#4F8EF7' },
                          { name: 'Bộ Quà Tặng', amount: '$88', value: 15, color: '#A0A0A0' },
                        ].map((row) => (
