...
const AdminDashboard = () => {
  ...
  const fundingData = useMemo(
    () => [
      { name: 'Eau de Parfum', value: 40, amount: '1.08 tỷ ₫', color: '#D56844' },
      { name: 'Eau de Toilette', value: 35, amount: '323 triệu ₫', color: '#4F8EF7' },
      { name: 'Bộ Quà Tặng', value: 10, amount: '33 triệu ₫', color: '#A0A0A0' },
    ],
    []
  );
            ...
            {activeNav === 'Tổng Quan' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                  ...
                  <StatCard title="Tổng Doanh Thu" value="₫15.6 tỷ" icon={Landmark} tone="green" />
                      ...
                      <div className="flex items-center gap-3">
                        {['2023', '2024', '2025', '2026'].map((year) => (
                          <button
                            ...
                            className={`text-sm px-3 py-2 rounded-xl backdrop-blur-lg outline-none transition-colors ${selectedYears.includes(year)
                    ...
                    <div className="mt-5 grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6 items-center">
                      <div className="h-[240px] relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                          ...
                          <div className="text-[22px] text-[#1a1a1a] font-bold">₫14,370,000</div>
                        </div>
                      </div>

                      <div className="space-y-3">
                        {[
                          { name: 'Eau de Parfum', amount: '₫10,810,000', value: 40, color: '#D56844' },
                          { name: 'Eau de Toilette', amount: '₫3,230,000', value: 35, color: '#4F8EF7' },
                          { name: 'Bộ Quà Tặng', amount: '₫330,000', value: 10, color: '#A0A0A0' },
                        ].map((row) => (
